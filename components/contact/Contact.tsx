...
const Contact = () => {
  return (
    <section className="contact-section bg w-full px-4 pt-[10vw] pb-[4vw]" id="contact-id">
      <div className="title text-center">
        <h2 className="contact-title text-[10vw] leading-[.8] textt tracking-tighter font-extrabold">
          <span className="line block overflow-hidden">
            <TextSplit text="contact"></TextSplit>
          </span>
        </h2>
      </div>
      <div className="contact-para text-center text-4xl ll flex justify-center pt-[6vw]">
        <p className="w-[70%]">
